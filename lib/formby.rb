...
module Formby
  ...
  class Input < Base
    needs :id=>nil,:value=>nil,:style=>nil,:readonly=>false,:class=>nil
    def classes
    ...
    def standard_attributes
      {  :name=>self.fullname, :id=>(@id and @id.to_s),:value=>@value, :type=>self.type, :style=>@style, :readonly=>@readonly, :class=>self.classes }
    end
    def content
